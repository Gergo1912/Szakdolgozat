...
\subsection{Időzített automaták}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.5]{GanttDiagram}
\caption{Egy ütemezés Gantt diagramon való megjelenítése}
\label{GanttDiagram}
\end{center}
\end{figure}
\section{Profitmaximalizálás}
...
\caption{A jövedelem maximalizáló algoritmus pszeudó kódja}
