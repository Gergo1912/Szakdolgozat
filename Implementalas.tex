...
Az S-gráf megoldó szoftver egy a Pannon Egyetem, Műszaki Informatikai Kar, Rendszer- és Számítástudományi Tanszék által fejlesztett szoftver. C++ nyelven íródott, amely képes nagy teljesítményre, ami fontos a tudományos területeken. A szoftverben a C++ nyelv sajátosságai fedezhetőek fel, többek között az objektum orientált paradigma, valamint különböző, a nyelvbe nem beépített tárolók és algoritmusok.
...
\begin{lstlisting}[language=C++, caption={Taszkokhoz tartozó százalékok mátrixának növelése}, frame={single}]
